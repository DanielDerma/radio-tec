            ...
            <>
              <div className="">
                <button
                  ...
                  className="mt-5 rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primaryHover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryActive"
                >
                  Actualizar
                </button>
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  Lista de videos. Automatico cada 4 hrs.
                </p>
              </div>
              <div className="mt-10 text-center lg:mt-12 lg:text-left">
                <div>
