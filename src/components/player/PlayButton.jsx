...
export function PlayButton({ player, size = 'large' }) {
  return (
    <button
      type="button"
      className={clsx(
        'group relative flex flex-shrink-0 items-center justify-center rounded-full bg-primary hover:bg-primaryHover focus:outline-none focus:ring-primaryHover',
        {
